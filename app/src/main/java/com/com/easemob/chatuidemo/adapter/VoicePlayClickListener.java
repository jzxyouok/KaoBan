...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ChatMessage) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((ChatMessage) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((ChatMessage) activity).playMsgId != null && ((ChatMessage) activity).playMsgId.equals(message.getMsgId())) {
