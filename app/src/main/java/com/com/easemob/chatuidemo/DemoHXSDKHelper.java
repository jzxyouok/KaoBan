...
import com.dezhou.lsy.projectdezhoureal.VideoCallActivity;
import com.dezhou.lsy.projectdezhoureal.VoiceCallActivity;
    ...
    protected HXNotificationInfoProvider getNotificationListener() {
        ...
        return new HXNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                //设置点击通知栏跳转事件
                Intent intent = new Intent(appContext, ChatMessage.class);
                //有电话时优先跳转到通话页面
                if(isVideoCalling){
